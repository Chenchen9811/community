...
//        redisTemplate.opsForHash().put(redisKey, "age", 999888);
//        redisTemplate.opsForHash().put(redisKey, "id", 1);
    ...
    public void testSet() {
        ...
        redisTemplate.opsForSet().add(redisKey, "刘备", "张飞", "关羽", "awajiwo", "nawaji");
    ...
    public void testZSet() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "唐僧", 20);
        redisTemplate.opsForZSet().add(redisKey, "悟空", 30);
        redisTemplate.opsForZSet().add(redisKey, "八戒", 10);
        redisTemplate.opsForZSet().add(redisKey, "沙僧", 5);
        redisTemplate.opsForZSet().add(redisKey, "白龙马", 10);
    ...
    public void testTransactional() {
        ...
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                redisOperations.opsForSet().add(redisKey, "666");
                System.out.println(redisOperations.opsForSet().members(redisKey)); // redis在事务期间不能执行查询语句，这里输出是空
    ...
    public void testBitMapOperation() {
        String rediskey2 = "test:bmp:02";
        redisTemplate.opsForValue().setBit(rediskey2, 0, true);
        redisTemplate.opsForValue().setBit(rediskey2, 1, true);
        redisTemplate.opsForValue().setBit(rediskey2, 2, true);

        String rediskey3 = "test:bmp:03";
        redisTemplate.opsForValue().setBit(rediskey3, 2, true);
        redisTemplate.opsForValue().setBit(rediskey3, 3, true);
        redisTemplate.opsForValue().setBit(rediskey3, 4, true);

        String rediskey4 = "test:bmp:04";
        redisTemplate.opsForValue().setBit(rediskey4, 4, true);
        redisTemplate.opsForValue().setBit(rediskey4, 5, true);
        redisTemplate.opsForValue().setBit(rediskey4, 6, true);

        String rediskey = "test:bmp:or";
